...
import static by.epamtc.iovchuk.creator.BallCreatorUtil.createBall;
import static org.junit.Assert.assertEquals;

public class BlueBallsCountCalculatorTest {

    BlueBallsCountCalculator blueBallsCountCalculator = new BlueBallsCountCalculator();
    Basket basket;
    ...
    public void testCalculate_whenBasketIsNull() {
        double expected = -1;
        double actual = blueBallsCountCalculator.calculate(null);
    ...
    public void testCalculate() {
        double expected = 2;
        double actual = blueBallsCountCalculator.calculate(basket);
        assertEquals(expected, actual, 0.01);
    }
